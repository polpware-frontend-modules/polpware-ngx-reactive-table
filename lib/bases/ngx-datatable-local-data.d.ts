...
export declare abstract class NgxDatatableLocalDataWithInlineSearch<T extends IRowDataType> extends NgxDatatablePoweredBase<T> implements ITableWithOperationsBase<T>, ISearchCapabiltyBuilder {
    SelectionType: typeof SelectionType;
    selected: Array<T>;
    editing: {
        [key: string]: boolean;
